...
The package lock and complete provenance are committed under `eng/sdk-generation` and `areas/cosmos/src/AzureMcp.Cosmos/GeneratedSdk/spec.lock.json`.
...
AzureMcp.Cosmos build with full generated source
AzureMcp.Cosmos build with projected generated source
...
Generated source is compiled directly into `AzureMcp.Cosmos.dll`. Package configurations therefore include both the area assembly and released management assembly, while generated configurations contain one merged area assembly.
